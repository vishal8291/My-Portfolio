...
export default function ContactPage() {
  ...
  const contactInfo = [
    {
      label: 'Email', value: 'vishaltiwari101999@gmail.com', href: 'mailto:vishaltiwari101999@gmail.com', color: '#818cf8',
    ...
    {
      label: 'Phone', value: '+91 8291569470', href: 'tel:+918291569470', color: '#22d3ee',
    ...
    {
      label: 'GitHub', value: 'github.com/vishal8291', href: 'https://github.com/vishal8291', color: '#f472b6',
    ...
    {
      label: 'LinkedIn', value: 'linkedin.com/in/vishal-tiwari-158a5216b', href: 'https://www.linkedin.com/in/vishal-tiwari-158a5216b', color: '#34d399',
    ...
    {
      label: 'Location', value: 'Mumbai, Maharashtra, India', href: null, color: '#fbbf24',
  ...
  return (
    <div style={{ padding: '110px 24px 90px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '56px' }}>
        ...
        {/* Contact info */}
        <div>
          <h2 style={{ fontSize: '1.15rem', fontWeight: 800, marginBottom: '10px', color: '#e2e8f0', letterSpacing: '-0.015em' }}>Contact Details</h2>
          <p style={{ color: '#64748b', fontSize: '0.875rem', marginBottom: '28px', lineHeight: 1.7 }}>
            ...
            {contactInfo.map(({ label, value, href, icon, color }) => {
              const inner = (
                <>
                  ...
                  <div>
                    <div style={{ fontSize: '0.68rem', color: '#475569', fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase', marginBottom: '2px' }}>{label}</div>
        ...
        <div>
          {status === 'sent' ? (
            <div style={{ textAlign: 'center', padding: '60px 24px', borderRadius: '16px', background: 'rgba(52,211,153,0.06)', border: '1px solid rgba(52,211,153,0.22)' }}>
              <div style={{ fontSize: '3rem', marginBottom: '16px' }}>✓</div>
              <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: '#34d399', marginBottom: '10px' }}>Message Sent!</h3>
              <p style={{ color: '#64748b', fontSize: '0.9rem' }}>Thanks for reaching out. I&apos;ll get back to you soon.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit}>
              {[
                ...
                <div key={key} style={{ marginBottom: '18px' }}>
                  <label style={{ display: 'block', fontSize: '0.75rem', color: '#64748b', marginBottom: '8px', fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase' }}>{label}</label>
              ...
              <div style={{ marginBottom: '28px' }}>
                <label style={{ display: 'block', fontSize: '0.75rem', color: '#64748b', marginBottom: '8px', fontWeight: 700, letterSpacing: '0.07em', textTransform: 'uppercase' }}>Message</label>
              ...
              <button type="submit" className="btn-primary"
                style={{ width: '100%', padding: '15px', borderRadius: '10px', border: 'none', cursor: 'pointer', fontWeight: 700, fontSize: '0.95rem', color: '#fff', letterSpacing: '0.04em' }}>
                Send Message →
              </button>
            </form>
          )}
