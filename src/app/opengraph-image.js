...
export const alt = 'Vishal Tiwari, freelance full-stack developer in Mumbai'
    ...
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: '#ffffff', padding: '72px 80px', fontFamily: 'sans-serif' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ fontSize: 76, fontWeight: 700, color: '#161514', lineHeight: 1.05, letterSpacing: -2 }}>Websites and business tools</div>
          <div style={{ display: 'flex', fontSize: 76, fontWeight: 700, lineHeight: 1.05, letterSpacing: -2 }}>
            <span style={{ color: '#161514' }}>that&nbsp;</span><span style={{ color: '#0f5c45' }}>keep working</span>
          </div>
        </div>
