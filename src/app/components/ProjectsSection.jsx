  ...
  return (
    <section style={{ padding: '80px 0' }}>
      <div style={{ marginBottom: '48px' }}>
        <div className="line-decoration" style={{ margin: '0 auto 16px' }} />
        <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', fontWeight: 900, textAlign: 'center', marginBottom: '12px', letterSpacing: '-0.02em' }}>
          Featured <span className="gradient-text">Projects</span>
        </h2>
        <p style={{ color: '#475569', textAlign: 'center', maxWidth: '460px', margin: '0 auto', lineHeight: 1.7, fontSize: '0.95rem' }}>
          ...
          <div key={project.title} className="card-glass"
            ...
            <div style={{ padding: '24px', flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <a href={project.githubUrl} target="_blank" rel="noopener noreferrer"
                style={{ display: 'flex', alignItems: 'center', gap: '6px', color: '#475569', textDecoration: 'none', fontSize: '0.82rem', fontWeight: 500 }}>
      ...
      <div style={{ textAlign: 'center' }}>
        <Link href="/projects" className="btn-primary"
          style={{ padding: '13px 32px', borderRadius: '10px', fontWeight: 700, fontSize: '0.92rem', color: '#fff', textDecoration: 'none' }}>
          View All Projects →
        </Link>
      </div>
    </section>
