...
export const metadata = {
  title: 'About',
  description: 'Vishal Tiwari, founder of CustomeAI: full-stack developer from Borivali, Mumbai. Story, skills and certificates.',
  alternates: { canonical: '/about' },
}

const journey = [
  { yr: '2026', title: 'Founded CustomeAI', text: 'Started CustomeAI, a studio for websites, AI agents and automation. Delivered MAHAGRO INDIA\'s booking site, our first paid client project, and launched Wonder Quest, my own online store.' },
  ...
  { yr: '2023', title: 'Foundations', text: 'C, C++, Java and web technologies.' },
    ...
    <>
      <header className="page-head">
        <div className="wrap about">
          <img src="/images/vishal-portrait.jpg" alt="Vishal Tiwari" className="portrait" width="640" height="640" />
          <div>
      ...
      <section className="section">
        <div className="wrap two-col">
          <div>
            ...
            <h2 style={{ fontSize: '1.7rem', marginBottom: 18 }}>From first projects to a studio.</h2>
            <p>
              I started programming in 2022. Since then I&apos;ve built projects across online stores, healthcare and
              legal tech, each with real logins, databases, payments and deployment.
            </p>
        ...
        <div className="wrap">
          <div className="section-head">
            <div>
              ...
              <h2>{certificates.length} certificates, each one viewable.</h2>
            </div>
          </div>
          <ul className="rows cert-rows">
            {certificates.map((c) => (
              <li key={c.title}>
