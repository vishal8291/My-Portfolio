// What CustomeAI builds, each tied to real work that proves it. Kept in step
// with customeai.tech: same three offerings, same promises, same process.
...
export const capabilities = [
  { title: 'Bookings and payments', what: 'Razorpay deposits and full payments by UPI and card, with a WhatsApp route if payment ever fails.' },
  { title: 'Online stores', what: 'Catalogue, cart, checkout, coupons and automatic delivery of digital products.' },
  { title: 'Admin panels', what: 'Every booking, enquiry and order in one place, with export to Excel.' },
