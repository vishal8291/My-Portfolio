...
export default function Footer() {
  ...
  const socials = [
    {
      href: 'https://github.com/vishal8291', label: 'GitHub',
    ...
    {
      href: 'https://www.linkedin.com/in/vishal-tiwari-158a5216b', label: 'LinkedIn',
      icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>,
    },
    {
      href: 'https://x.com/vishalT200', label: 'Twitter',
  ...
  return (
    <footer style={{ background: '#06080e', borderTop: '1px solid rgba(139,92,246,0.12)', padding: '56px 24px 32px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '48px', marginBottom: '48px' }}>
          ...
          <div style={{ gridColumn: 'span 1' }}>
            <div style={{ fontSize: '1.6rem', fontWeight: 900, letterSpacing: '-0.03em', marginBottom: '14px' }}>
            ...
            <p style={{ color: '#64748b', fontSize: '0.875rem', lineHeight: 1.75, maxWidth: '240px', marginBottom: '22px' }}>
          ...
          {/* Links */}
          <div>
            <h3 style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#475569', marginBottom: '18px' }}>
              Navigation
            </h3>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '11px' }}>
              {[
                ...
                { icon: '📱', text: '+91 8291569470', href: null },
        ...
        {/* Bottom */}
        <div style={{ borderTop: '1px solid rgba(139,92,246,0.1)', paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
          ...
          <p style={{ color: '#334155', fontSize: '0.82rem' }}>Built with Next.js &amp; Tailwind CSS</p>
        </div>
      </div>
    </footer>
  )
